...
<body>
    ...
    <div class="admincontent">
        ...
        <div class="main">
            ...
            <div class="addbutton">
                <a href="./add/addtrainer.php" class="btn" style="display: inline-block; text-align: center; padding: 10px 20px; background: orange; color: white; text-decoration: none; border-radius: 5px;">Add Trainer</a>
            </div>
