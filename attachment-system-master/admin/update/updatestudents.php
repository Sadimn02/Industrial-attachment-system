...
<body>
    ...
    <form method="post" action="">
        ...
        <div class="inputform">
            ...
            <a href="../registeredstudents.php" class="btn" style="display: inline-block; text-align: center; padding: 10px 20px; background: orange; color: white; text-decoration: none; border-radius: 5px;">BACK</a>
        </div>
    </form>
</body>
